...
class GenericSwitchHandler:
    """Generic mqtt switch object"""  # __doc__ / docstring
    ...
    _gpio_switch_control_active = True
    ...
    def __init__(self, switch_output_pin, switch_output_active=True):
        self._gpio_switch_control_pin = switch_output_pin
        self._gpio_switch_control_active = switch_output_active
    ...
    def state_in(self, state):
        if not self._gpio_switch_control_active:
            return not state
        return state
